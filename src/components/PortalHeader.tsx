        ...
        <div className="py-3.5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <div>
                <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-orange-50 text-orange-700 border border-orange-200/80">
                  Student Portal
                </span>
              </div>
              <p className="text-xs font-bold text-slate-800 truncate max-w-xs sm:max-w-md mt-1">
                {student.university}
              </p>
            </div>
          </div>
